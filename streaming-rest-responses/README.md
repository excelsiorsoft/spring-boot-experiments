...
Hit the `api/download` endpoint, 


![README5](https://github.com/excelsiorsoft/spring-boot-experiments/blob/master/streaming-rest-responses/README_images/README5.png)

which by default gets redirected to the `/login` endpoint, credentials are **admin/admin**:
